...
export default class MyMap {
  ...
  _fetchCoordinate() {
    axios.get('./json/address-sample.json')
    ...
    /* test */
    /*axios.get('https://naveropenapi.apigw.ntruss.com/map-static/v2/raster?w=400&h=300&center=127.1054221,37.3591614&level=14',
      {
        mode: 'no-cors',
        headers: {
          'X-NCP-APIGW-API-KEY-ID': 'bh6uk4dbzi',
          'X-NCP-APIGW-API-KEY': 'W55tjQK466mOKXaiYHeoSOkwAZoCX2rQgOg6gWc4'
        }
      })
      .then(function (response) {
        // 성공 핸들링
